        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SnapDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Snapshots_Symbols_SymbolId",
                        column: x => x.SymbolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SymbolUser", x => new { x.SymbolsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_SymbolUser_Symbols_SymbolsId",
                        column: x => x.SymbolsId,
                        principalTable: "Symbols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SymbolUser_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Snapshots_SymbolId_SnapDate",
                table: "Snapshots",
                columns: new[] { "SymbolId", "SnapDate" },
                unique: true);
